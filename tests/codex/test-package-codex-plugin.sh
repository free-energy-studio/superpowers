...
assert_not_matches "$archive_paths" 'anthropic-best-practices\.md$' "archive excludes historical vendor guidance"
assert_not_matches "$archive_paths" '(persuasion-principles|CLAUDE_MD_TESTING|CREATION-LOG|test-academic|test-pressure-[123])\.md$' "archive excludes retired instruction examples"
...
assert_contains "$archive_paths" "skills/applying-development-principles/SKILL.md" "archive includes the shared principles skill"
